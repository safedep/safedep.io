...
excerpt: Experiments with agentic workflows for malicious package analysis built using a Claude Desktop, Model Context Protocol (MCP) server, static code analysis and SafeDep Cloud API tools.
tags:
  - npm
  - malware
---
...
![](/images/malysis-agentic-workflow.png)
