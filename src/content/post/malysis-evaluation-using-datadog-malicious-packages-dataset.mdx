...
excerpt: Analysis of malicious open source packages from Datadog's malicious packages dataset. Each of these packages was found in the wild and confirmed to be malicious. The goal of this analysis is to understand the nature of malicious OSS packages and how they are distributed in the wild.
tags:
  - npm
  - pypi
  - analysis
...
- Analysis of a total of 5,576 open source packages from [DataDog Malicious Packages Dataset](https://github.com/DataDog/malicious-software-packages-dataset)
...
The distribution file extensions that that contributed to evidences (signals) based on which a package was classified as malicious are shown below.
...
Following customizations were made
